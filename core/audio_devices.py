"""
core/audio_devices.py — pick which microphone and which speakers LangVis uses.
...
WHY
    ...
    "LangVis can't hear me" almost always means "LangVis is listening to the
...
WHY THIS IS CACHED
    ...
    milliseconds on a Windows machine with many endpoints. This was learned
